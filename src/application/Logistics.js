...
const Logistics = () => {
    const[category , setCategory] = useState([])
         ...
         try{
            const response = await fetch("https://logibricks.com/api/blogs/logistics-management?page=1")
    ...
    <div style={{
              ...
              backgroundColor: "#8338ec14"
                 ...
                 <h1 style={{textAlign:"center" , backgroundColor: "#8338ec14"}}>Logistics-management</h1>
        {category.map((detail)=>{
            return(
                <div >
                <p>{detail.title}</p>
